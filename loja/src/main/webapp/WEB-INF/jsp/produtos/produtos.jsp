      ...
      <c:forEach var="produto" items="${produtos}">
        <div class="col-lg-4 col-sm-6 mb-3">
          <div class="portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1${produto.id}">
        ...
        <!-- Modal 1-->
        <div class="portfolio-modal modal fade" id="portfolioModal1${produto.id}" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="row justify-content-center">
                  <div class="col-lg-8">
                    <div class="modal-body">
                      ...
                      <h2 class="text-uppercase">${produto.precoProduto}</h2>
