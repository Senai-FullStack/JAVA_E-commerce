    ...
    <body id="page-top">
        ...
        <section class="page-section" id="formcategoria">
            <div class="container">
                ...
                <input class="form-control"  value="${categoria.getId()}" name="categoria.id"> 
                <input class="form-control"  value="${categoria.isAtivo()}" name="categoria.ativo">                  
                    <div class="row justify-content-md-center mb-5 text-center">
                        <div class="col-md-12 align-self-center text-center">
                            <div class="form-group input-login mx-auto">
                                <input class="form-control" id="categoria" value="${categoria.getNomeCategoria()}" name="categoria.nomeCategoria" type="text" placeholder="Nome *" required="required" minlength="3" maxlength="50"  data-validation-required-message="A categoria deve ter entre 3 e 50 caracteres" />
